...
func (p *Printer) Data() (Data, error) {
	...
	final := Data{
		...
		SubtaskID:               data.Print.SubtaskID,
		TaskID:                  data.Print.TaskID,
		ProjectID:               data.Print.ProjectID,
		ProfileID:               data.Print.ProfileID,
		BigThumbnail:            data.Print.BigThumbnail,
		PreparationStage:        PreparationStage(data.Print.StgCur),
		PreparationProgress:     data.Print.StgPct,
		FilamentWeight:          data.Print.TotalWeight,
		FilamentCost:            data.Print.FilamentCost,
		AmsMapping:              data.Print.AmsMapping,
